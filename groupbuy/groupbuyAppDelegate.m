...
//			   viewControllers:controllers];	
    ...
    CommonProductListController* favorController = (CommonProductListController*)[UIUtils addViewController:[CommonProductListController alloc]
                                                                                           ...
                                                                                           hasNavController:YES			
                                                                                            viewControllers:controllers];	
    favorController.dataLoader = [[[ProductFavoriteDataLoader alloc] init] autorelease];
    [favorController setBackgroundImageName:@"background.png"];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    [productService updateKeywords:KEYWORD_TYPE_TAOBAO_MIAOSHA];
